...
double task_fast_cost=3.615935011496966;
double diff=0.9036478688548292;// diff=max(a-cnt*b,c)
...
int main(int argc,char* argv[]){
    ...
    if(argc>=3){
        ...
        task_fast_cost=string2double(string(argv[2]));
        diff=string2double(string(argv[3]));
        expect_th=string2double(string(argv[4]));
        task_rnd_init_per=string2double(string(argv[5]));
        task_rnd_lim_day=string2double(string(argv[6]));
    }
    #endif//MORIRIN
    cin.tie(0);
